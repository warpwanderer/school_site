        ...
        <div class="row">
            <div class="col">
                <div class="content">
                    ...
                    $query = mysql_query("SELECT `id`, `title`, `text`, `image` FROM `news` WHERE `id` = " . $id . " LIMIT 1");
                    $result = mysql_fetch_array($query);
                    $i = 0;
                    ?>
                    <h1 class="text-center title pt-2"><?= $result['title']; ?></h1>
                    <section>
                        <?php
                        echo '<div class="news m-3">';
                        if ($result['image'] != '') {
                            echo '<div class=""><img src="../src/images/news/' . $result['image'] . '" width="200"></div>';
                        }
                        echo '<div class="text">' . $result['text'] . '</div>';
                        echo '<a href="news.php"><div class="about">Назад</div></a>';
